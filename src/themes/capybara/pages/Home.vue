<template>
  <div id="home">
    <div class="top-category-nav margin-big">
      <vsf-button full-width color="secondary" class="margin-right-small">Women</vsf-button>
      <vsf-button full-width color="secondary" class="margin-left-small">Men</vsf-button>
    </div>
    <popular-categories />
    <vsf-banner class="margin-big" width="100%">
      <template slot="subtitle">Subtitle</template>
      <template slot="title">Title</template>
      <template slot="description">Description</template>
    </vsf-banner>
    <vsf-banner class="margin-big" width="50%">
      <template slot="subtitle">Subtitle</template>
      <template slot="title">Title</template>
      <template slot="description">Description</template>
    </vsf-banner>
